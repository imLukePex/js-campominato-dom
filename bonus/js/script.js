...
// selezione select livelli di difficoltà
const levelDifficulty = document.getElementById("levels");


// punteggio
let punteggio = 0;

// creazione ciclo per livello FACILE
...
// creazione ciclo per livello DIFFICILE
} else if (levelDifficulty.value === "2") {

    // generare un array di numeri in ordine casuale in un range
    const newArrayNum = createMyArray(1, 81, 16);
    ...
    // comparsa griglia al click del playbutton
        playButton.addEventListener("click",
            ...
            function () {
                ...
                gridElement.append(myElement);
                myElement.append(i);
                myElement.classList.add("livello-hard");
...
// creazione ciclo per livello PRO 
} else {

    // generare un array di numeri in ordine casuale in un range
    const newArrayNum = createMyArray(1, 49, 16);
    ...
    // comparsa griglia al click del playbutton
        playButton.addEventListener("click",
            ...
            function () {
                ...
                gridElement.append(myElement);
                myElement.append(i);
                myElement.classList.add("livello-pro");
